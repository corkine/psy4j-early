...
/**
 * Experiment 所依赖的早期版本的 JavaFx GUI 入口
 */
public class Main extends Application {
    ...
    private Parent drawWelcomeContent() {
        ...
        Text text = new Text(log.getCurrentVersion() + "\n" + log.getLog());
        root.setBottom(text);
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle(String.format("Psychology ToolKit - %s - Loved by Corkine",log.getCurrentVersion()));
